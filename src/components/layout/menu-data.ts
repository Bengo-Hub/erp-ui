    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Consultants", to: "/payroll/consultants" },
          ...
          { label: "Staff Purchases", to: "/payroll/staff-purchases", permissions: ["view_advances"] },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Rosters", to: "/hrm/attendance/rosters" },
          { label: "Shift Rotations", to: "/hrm/attendance/shift-rotations" },
          { label: "Overrides", to: "/hrm/attendance/overrides" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Metrics", to: "/hrm/performance/metrics" },
          { label: "Targets & Scores", to: "/hrm/performance/targets" },
        ],
      },
      {
        label: "Training",
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Onboarding", to: "/hrm/recruitment/onboarding" },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Document Numbering", to: "/settings/document-numbering" },
